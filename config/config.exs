...
config :prettycore, PrettycoreWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PrettycoreWeb.ErrorHTML, json: PrettycoreWeb.ErrorJSON],
    layout: false
  ],
...
# Scheduler de tareas programadas (Quantum)
config :prettycore, Prettycore.Scheduler.QuantumScheduler,
  jobs: [],
