defmodule PrettycoreWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PrettycoreWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PrettycoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PrettycoreWeb.Gettext, "errors", msg, opts)
    end
  end
